    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                '<span class="sr-only">Filtrar columnas</span></button>',
        ...
        if (this.options.search) {
            html = [];
            html.push(
                '<div class="pull-' + this.options.searchAlign + ' search"><label for="id-search" class="sr-only">Buscar</label>',
                sprintf('<input id="id-search" class="form-control' +
