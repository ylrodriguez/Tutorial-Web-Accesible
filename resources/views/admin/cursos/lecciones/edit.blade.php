             ...
             <div class="col-md-12">
                    <div class="panel panel-default" style="border: 0px">
                     <div class="panel-body" style="@if (Auth::user()->discapacidad == "daltonismo" || Auth::user()->discapacidad =="ceguera")background-color: #2c3e50; @else background-color: #375A7F; @endif">
                         <div class="col-md-12">
                         <h1 id= "title-course" style="color: white">Editar lección: </h1>
                         <hr/>
                         <h2 class="midsize" style="color: #d2d2d2">Curso: {{$leccion->curso->titulo}}</h2>
                         </div>
                    </div>
                    </div>
            </div>
                    ...
                    <div class="panel-body">
                        ...
                        {{-- Titulo --}}
                          <div class="row">
                            ...
                            {!! Form::text('titulo',$leccion->titulo,['class' => 'form-control', 'placeholder' => 'Ejemplo: Procesadores', 'required' ]) !!}
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            {!! Form::textarea('descripcion',$leccion->descripcion,['size' => '30x5','class' => 'form-control', 'placeholder' => 'Ejemplo: En esta leccion trataremos los conceptos principales de los procesadores.', 'required','maxlength'=>'255', 'minlength'=>'5' ]) !!}
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            {!! Form::textarea('teoria', $leccion->teoria, ['class' => 'form-control ta-content']) !!}
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="input-group">
                                {!! Form::text('linkvideo',$leccion->linkvideo,['class' => 'form-control', 'placeholder' => 'Ejemplo: oAPdNKTrBYA', 'required' ]) !!}
                          ...
                          <div class="form-group">
                            <a href="{{route('admin.cursos.lecciones.show',$leccion->curso->id)}}" class="btn btn-warning">
                            <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>  Volver atrás</a>
                            <input id="boton-editar" class="btn btn-primary  pull-right disabled" disabled type="submit" value="Editar lección">
                          </div>
                         {!! Form::close() !!}
                         </div>
                    </div>
