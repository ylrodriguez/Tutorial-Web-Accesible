<nav class="navbar navbar-default" >
  <div class="container-fluid" id="top">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand figura-cuadrado" href="/admin">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <div id="lecciones-div">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown" id="leccion-dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Lecciones<span class="caret" id="Este"></span></a>
           ...
           <li><a href="{{ route('admin.progreso.index') }}">Progreso</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="/admin">Página principal</a></li>
        <li><a href="/admin#chat">Chat</a></li>
        <li><a href="{{ route('admin.ayuda.index') }}">Ayuda</a></li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Opciones<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="{{ route('admin.perfil.show', Auth::user()->slug) }}"><span class="glyphicon glyphicon-user" style="padding-right: 5px;"></span>Mi perfil</a></li>
            <li><a href="{{ route('admin.configuracion.index') }}"><span class="glyphicon glyphicon-cog" style="padding-right: 5px;"></span>Configuración</a></li>
